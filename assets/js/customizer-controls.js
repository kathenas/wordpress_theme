	...
	wp.customize( 'custom_logo', function( setting ) {
		setting.bind( function( value ) {
			if ( '' !== value ) {
				...
				wp.customize.instance( 'kathenas_theme_options[retina_logo]' ).set( false );
			}
		});
		...
		wp.customize.control( 'kathenas_theme_options[retina_logo_title]', setupControl );
		wp.customize.control( 'kathenas_theme_options[retina_logo]', setupControl );
	} );
